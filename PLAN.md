...
1. **0.1.1 재배포** — 릴리스 노트는 영어(언어 정책), `rokit trust` 안내 포함.
   RN-1~RN-5 는 전부 닫혔다 (PR #15·#16·#17·#18·#19). 다섯 다 재현부터 하고 고쳤고,
   RN-3 과 RN-5 는 재현이 항목의 성격을 바꾸었다 — 상세는
   [docs/known-issues.md](docs/known-issues.md) 의 해결됨 절과 CHANGELOG.
